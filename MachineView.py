...
class MachineView:
    ...
    def create_window(self):
        ...
        # Text for the output
        self.right_output_text = Text(self.right_output_frame, width=45, height=10, bg="WHITE", wrap="word", state=DISABLED)
    ...
    def display_contents(self, model):
        ...
        self.right_output_text.tag_configure("red", foreground="red")
        self.right_output_text.insert(END, "FILE NAME: " + model.get_text_file_name() + "\n", "red")
